...
public class NoteController {
	...
	public NoteController() {
		...
		noteRepository=context.getBean("noteRepository",NoteRepository.class);
	}
	...
	public String shoWNote(Model model) {
		...
		model.addAttribute("noteRep",noteRepository);
		return "index";
	}
	/*
	...
	public String addNote(Model model,@RequestParam int noteId,@RequestParam String noteTitle,@RequestParam String noteContent,@RequestParam String noteStatus) {
